...
class StringParameter(name: String, defaultValue: String, protected val _isMultiline: Boolean = false,
    protected val _isPattern: Boolean = false, protected val _isPassword: Boolean = false)
