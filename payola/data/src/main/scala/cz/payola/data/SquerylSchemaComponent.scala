...
trait SquerylSchemaComponent
{
    ...
    /**
      ...
      */
    class SquerylSchema extends Schema
    {
        /**
        ...
        /**
          * Relation that associates [[cz.payola.data.entities.analyses.DataSource]]s to their owners ([[cz.payola.data
          * .entities.User]]s)
          */
        ...
        /**
          * Relation that associates [[cz.payola.data.entities.analyses.PluginDbRepresentation]] to a [[cz.payola.data
        ...
        /**
          * Relation that associates [[cz.payola.data.entities.analyses.PluginDbRepresentation]] to an [[cz.payola.data
          * .entities.Analysis]]
          */
        ...
        /**
          * Relation that associates [[cz.payola.data.entities.analyses.DataSource]]s to a [[cz.payola.data.entities
        ...
        /**
          * Relation that associates [[cz.payola.data.entities.analyses.PluginInstanceBinding]]s to a [[cz.payola.data
          * .entities.Analysis]]
          */
        ...
        /**
          * Relation that associates [[cz.payola.data.entities.analyses.parameters.BooleanParameterValues]]s to a boolean
          * parameter
          */
        ...
        /**
          * Relation that associates [[cz.payola.data.entities.analyses.parameters.FloatParameterValue]]s to a [[cz.payola
          * .data.entities.analyses.parameters.FloatParameter]]
          */
        ...
        /**
          * Relation that associates [[cz.payola.data.entities.analyses.parameters.IntParameterValue]]s to an [[cz.payola
          * .data.entities.analyses.parameters.IntParameter]]
          */
        ...
        /**
          * Relation that associates [[cz.payola.data.entities.analyses.parameters.StringParameterValues]] to a [[cz
        ...
        /**
          * Relation that associates [[cz.payola.data.entities.analyses.parameters.BooleanParameter]] to a [[cz.payola
        ...
        /**
          * Relation that associates [[cz.payola.data.entities.analyses.parameters.FloatParameter]]s to a [[cz.payola.data
          * .entities.analyses.PluginDbRepresentation]]
          */
        ...
        /**
          * Relation that associates [[cz.payola.data.entities.analyses.parameters.IntParameter]]s to a [[cz.payola.data
          * .entities.analyses.PluginDbRepresentation]]
          */
        ...
        /**
          * Relation that associates [[cz.payola.data.entities.analyses.parameters.StringParameter]]s to a [[cz.payola
          * .data.entities.analyses.PluginDbRepresentation]]
          */
        ...
        /**
          * Relation that associates [[cz.payola.data.entities.analyses.parameters.BooleanParameterValues]]s to a [[cz
        ...
        /**
          * Relation that associates [[cz.payola.data.entities.analyses.parameters.StringParameterValues]]s to a [[cz
          * .payola.data.entities.analyses.parameters.StringParameter]]
          */
        ...
        /**
          * Relation that associates [[cz.payola.data.entities.analyses.parameters.FloatParameter]]s values to a [[cz
          * .payola.data.entities.analyses.DataSource]]
          */
        ...
        /**
          * Relation that associates [[cz.payola.data.entities.analyses.parameters.IntParameter]] to a [[cz.payola.data
          * .entities.analyses.DataSource]]
          */
        ...
        /**
          * Relation that associates [[cz.payola.data.entities.analyses.parameters.StringParameter]]s values to a [[cz
          * .payola.data.entities.analyses.DataSource]]
          */
        ...
        def connect(test: Boolean = false) {
            ...
            try {
                ...
                case e: Exception => {
                    println("Failed to connect. " + e); throw e
                }
            }
        }
