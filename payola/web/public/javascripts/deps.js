...
goog.addDependency('../cz/payola/web/client/views/graph/View.js', ['cz.payola.web.client.views.graph.View'], ['cz.payola.web.client.views.Layer', 'cz.payola.web.client.views.Vector']);
...
goog.addDependency('../cz/payola/web/client/views/graph/GraphView.js', ['cz.payola.web.client.views.graph.GraphView', 'cz.payola.web.client.views.graph.RedrawOperation'], ['cz.payola.web.client.views.Constants', 'cz.payola.web.client.views.Point', 'cz.payola.web.client.views.graph.Controls', 'cz.payola.web.client.views.graph.EdgeView', 'cz.payola.web.client.views.graph.LocationDescriptor', 'cz.payola.web.client.views.graph.VertexView', 'cz.payola.web.client.views.graph.View', 'scala.collection.immutable.List', 'scala.collection.mutable.ListBuffer', 'scala.math']);
