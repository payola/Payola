...
goog.addDependency('../cz/payola/web/client/Index.js', ['cz.payola.web.client.Index'], ['cz.payola.web.client.Layer', 'cz.payola.web.client.Point', 'cz.payola.web.client.Vector', 'cz.payola.web.client.graph.Drawer', 'cz.payola.web.client.graph.Edge', 'cz.payola.web.client.graph.Graph', 'cz.payola.web.client.graph.Vertex', 'goog.events', 'goog.events.EventType', 'scala.None', 'scala.Some', 'scala.collection.immutable.List']);
...
goog.addDependency('../cz/payola/web/client/graph/Edge.js', ['cz.payola.web.client.graph.Edge', 'cz.payola.web.client.graph.Quadrant'], ['cz.payola.web.client.Point', 'cz.payola.web.client.graph.Constants', 'scala.math']);
goog.addDependency('../cz/payola/web/client/graph/Graph.js', ['cz.payola.web.client.graph.Graph'], ['cz.payola.web.client.graph.Constants']);
goog.addDependency('../cz/payola/web/client/graph/Information.js', ['cz.payola.web.client.graph.Information'], ['cz.payola.web.client.Point', 'cz.payola.web.client.graph.Constants', 'scala.IndexOutOfBoundsException', 'scala.None', 'scala.Product', 'scala.Some', 'scala.Tuple2', 'scala.runtime.ScalaRunTime']);
goog.addDependency('../cz/payola/web/client/graph/Vertex.js', ['cz.payola.web.client.graph.Vertex'], ['cz.payola.web.client.graph.Constants', 'cz.payola.web.client.graph.Information']);
