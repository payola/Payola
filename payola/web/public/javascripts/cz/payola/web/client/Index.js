...
goog.events.listen(canvasText, goog.events.EventType.MOUSEDOWN, function($event) { self.onMouseDown($event);
 });
goog.events.listen(canvasText, goog.events.EventType.MOUSEMOVE, function($event) { self.onMouseMove($event);
 });
goog.events.listen(canvasText, goog.events.EventType.MOUSEUP, function($event) { self.onMouseUp($event);
 });
...
self.graph.getGraph().foreach(function(vertex) { (function() {
if (vertex.selected) {
