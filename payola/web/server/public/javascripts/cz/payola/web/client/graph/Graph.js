...
return self.vertices.find(function(vertex) {
return self.isPointInRect(p, vertex.position.add(topLeft), vertex.position.add(bottomRight));
});
...
var self = this;
return self.getGraph().exists(function(value) {
var exists = false;
self.getGraph().foreach(function(vertex) {
