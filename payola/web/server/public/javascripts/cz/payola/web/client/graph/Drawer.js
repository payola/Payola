...
if ((diff.x >= diff.y)) {
(function($selector$1) {
if (($selector$1 === cz.payola.web.client.graph.Quadrant.RightBottom) || ($selector$1 === cz.payola.web.client.graph.Quadrant.RightTop)) {
...
if (($selector$1 === cz.payola.web.client.graph.Quadrant.LeftBottom) || ($selector$1 === cz.payola.web.client.graph.Quadrant.LeftTop)) {
ctrl1.x = (A.x - (diff.x / cz.payola.web.client.graph.Constants.EdgeSIndex));
ctrl1.y = A.y;
ctrl2.x = (B.x + (diff.x / cz.payola.web.client.graph.Constants.EdgeSIndex));
ctrl2.y = B.y;
...
(function($selector$2) {
if (($selector$2 === cz.payola.web.client.graph.Quadrant.RightBottom) || ($selector$2 === cz.payola.web.client.graph.Quadrant.RightTop)) {
ctrl1.x = A.x;
...
if (($selector$2 === cz.payola.web.client.graph.Quadrant.LeftBottom) || ($selector$2 === cz.payola.web.client.graph.Quadrant.LeftTop)) {
ctrl1.x = A.x;
ctrl1.y = (A.y - (diff.y / cz.payola.web.client.graph.Constants.EdgeSIndex));
ctrl2.x = B.x;
ctrl2.y = (B.y + (diff.y / cz.payola.web.client.graph.Constants.EdgeSIndex));
...
var self = this;
graph.getGraph().foreach(function(vertex) {
vertex.neighbours.foreach(function(neighbourVertex) {
...
var somethingSelected = graph.getGraph().exists(function($x$1) {
return $x$1.selected;
});
graph.getGraph().foreach(function(vertex) {
var neighbourSelected = vertex.neighbours.exists(function($x$2) {
return $x$2.selected;
});
if (vertex.selected) {
