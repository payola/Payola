/* sigma.js - A JavaScript library dedicated to graph drawing. - Version: 1.0.0 - Author: Alexis Jacomy, Sciences-Po MĂ©dialab - License: MIT */
(function () {
    "use strict";
    var a = {}, b = function (c) {
            var d, e, f, g, h;
    ...
    if (b.prototype.addCamera = function (a) {
        ...
        return f = new d(this.graph, e, this.settings, g), this.renderers[c] = f, Object.defineProperty(f, "id", {
            value: c
        }), f.bind && f.bind(["click", "clickStage", "clickNode", "clickNodes", "overNode", "overNodes", "outNode", "outNodes", "downNode", "downNodes", "upNode", "upNodes"], this._handler), this.renderersPerCamera[e.id].push(f), f
        ...
        return arguments.length ? a[c] : b.utils.extends({}, a)
    }, "undefined" != typeof this.sigma) throw "An object called sigma is already in the global scope.";
    "undefined" != typeof exports ? ("undefined" != typeof module && module.exports && (exports = module.exports = b), exports.sigma = b) : this.sigma = b
}).call(this),
function (a) {
    "use strict";
    ...
    function b(a, c) {
        ...
        if (arguments.length)
            ...
            f = Array.isArray(a) ? a : a.split(/ /);
            for (d in f) e = f[d], C[e] || (C[e] = []), C[e].push({
                handler: c
            })
        }
    }
    ...
    function c(a, b) {
        var c, d, e, f, g = Array.isArray(a) ? a : a.split(/ /);
        if (arguments.length)
            if (b)
                for (c in g) {
                    if (f = g[c], C[f]) {
                        e = [];
                        for (d in C[f]) C[f][d].handler !== b && e.push(C[f][d]);
                        C[f] = e
                    }
                    C[f] && 0 === C[f].length && delete C[f]
                } else
                    for (c in g) delete C[g[c]];
...
function (a) {
    ...
    sigma.utils = sigma.utils || {}, sigma.utils.extend = function () {
        ...
        a.addEventListener(b, function (a) {
            return d++, 2 === d ? (d = 0, c(a)) : void(1 === d && setTimeout(function () {
                d = 0
...
function () {
    ...
    var a, b = 0,
        c = ["ms", "moz", "webkit", "o"];
    for (a = 0; a < c.length && !window.requestAnimationFrame; a++) window.requestAnimationFrame = window[c[a] + "RequestAnimationFrame"], window.cancelAnimationFrame = window[c[a] + "CancelAnimationFrame"] || window[c[a] + "CancelRequestAnimationFrame"];
...
function () {
    ...
    a.prototype.bind = function (a, b) {
        ...
        if (1 === arguments.length && "object" == typeof arguments[0])
            ...
            for (c in e) d = e[c], d && (this._handlers[d] || (this._handlers[d] = []), this._handlers[d].push({
                handler: b
            }))
        }
        return this
        ...
        if (b)
            for (c in g) {
                ...
                for (c in g) delete this._handlers[g[c]];
        return this
    }, a.prototype.dispatchEvent = function (a, b) {
        var c, d, e, f, g, h = this,
            i = "string" == typeof a ? a.split(" ") : a;
        b = void 0 === b ? {} : b;
        for (c in i)
            if (g = i[c], this._handlers[g]) {
                f = h.getEvent(g, b), e = [];
...
function () {
    "use strict";
    var a = function () {
        var b, c, d = {}, e = Array.prototype.slice.call(arguments, 0),
            f = function (a, g) {
                var h, i;
...
function () {
    ...
    i.addMethod = function (a, b) {
        ...
        if (c[a]) throw 'The method "' + a + '" already exists.';
        return c[a] = b, f[a] = Object.create(null), this
    }, i.attach = function (a, b, c) {
        if ("string" != typeof a || "string" != typeof b || "function" != typeof c || 3 !== arguments.length) throw "attach: Wrong arguments.";
        var d;
        if ("constructor" === a) d = e;
        else {
            if (!f[a]) throw 'The method "' + a + '" does not exist.';
            d = f[a]
        } if (d[b]) throw 'A function "' + b + '" is already attached to the method "' + a + '".';
        return d[b] = c, this
    ...
    }), "undefined" != typeof sigma ? (sigma.classes = sigma.classes || Object.create(null), sigma.classes.graph = i) : "undefined" != typeof exports ? ("undefined" != typeof module && module.exports && (exports = module.exports = i), exports.graph = i) : this.graph = i
}.call(this),
function (a) {
    "use strict";
    if ("undefined" == typeof sigma) throw "sigma is not declared";
...
function () {
    ...
    sigma.utils.pkg("sigma.captors"), sigma.captors.mouse = function (a, b, c) {
        ...
        function f(a) {
            w("mouseEnabled") && (q = !0, k = v.x, l = v.y, m = v.x, n = v.y, o = sigma.utils.getX(a), p = sigma.utils.getY(a), t.dispatchEvent("mouseup", {
        ...
        function i(a) {
            var b, c, d, e;
            return w("mouseEnabled") ? (d = 1 / w("doubleClickZoomingRatio"), e = Math.max(w("zoomMin"), Math.min(w("zoomMax"), v.ratio * d)), d = e / v.ratio, e !== v.ratio && (c = sigma.misc.animation.killAll(v), b = v.cameraPosition(sigma.utils.getX(a) - a.target.width / 2, sigma.utils.getY(a) - a.target.height / 2, !0), sigma.misc.animation.camera(v, {
                x: b.x * (1 - d) + v.x,
                y: b.y * (1 - d) + v.y,
                ratio: e
            }, {
        ...
        function j(a) {
            var b, c, d, e;
            return w("mouseEnabled") ? (d = sigma.utils.getDelta(a) > 0 ? 1 / w("zoomingRatio") : w("zoomingRatio"), e = Math.max(w("zoomMin"), Math.min(w("zoomMax"), v.ratio * d)), d = e / v.ratio, e !== v.ratio && (c = sigma.misc.animation.killAll(v), b = v.cameraPosition(sigma.utils.getX(a) - a.target.width / 2, sigma.utils.getY(a) - a.target.height / 2, !0), sigma.misc.animation.camera(v, {
                x: b.x * (1 - d) + v.x,
                y: b.y * (1 - d) + v.y,
                ratio: e
            }, {
...
function () {
    ...
    sigma.utils.pkg("sigma.captors"), sigma.captors.touch = function (a, b, c) {
        ...
        function h(a) {
            var b, c, e, f;
            return a.touches && 1 === a.touches.length && D("touchEnabled") ? (y = !0, e = 1 / D("doubleClickZoomingRatio"), f = Math.max(D("zoomMin"), Math.min(D("zoomMax"), C.ratio * e)), e = f / C.ratio, f !== C.ratio && (c = sigma.misc.animation.killAll(C), b = d(a.touches[0]), b = C.cameraPosition(b.x - a.target.width / 2, b.y - a.target.height / 2, !0), sigma.misc.animation.camera(C, {
                x: b.x * (1 - e) + C.x,
                y: b.y * (1 - e) + C.y,
                ratio: f
            }, {
        ...
        var i, j, k, l, m, n, o, p, q, r, s, t, u, v, w, x, y, z, A = this,
            ...
            D = c,
            E = [];
        sigma.classes.dispatcher.extend(this), sigma.utils.doubleClick(B, "touchstart", h), B.addEventListener("touchstart", e), B.addEventListener("touchend", f), B.addEventListener("touchcancel", f), B.addEventListener("touchleave", f), B.addEventListener("touchmove", g)
    }
}.call(this),
function (a) {
    "use strict";
    ...
    sigma.utils.pkg("sigma.renderers"), sigma.renderers.canvas = function (a, b, c, d) {
        ...
        b = b || {};
        var c, d, e, f, g, h, i, j, k, l, m, n, o = {}, p = this.graph,
            q = (this.options.prefix || "", this.settings(b, "drawEdges")),
            r = this.settings(b, "drawNodes"),
            s = this.settings(b, "drawLabels"),
            t = this.settings.embedObjects(b, {
                prefix: this.options.prefix
            });
        this.settings(b, "hideEdgesOnMove") && (this.camera.isAnimated || this.camera.isMoving) && (q = !1), this.camera.applyView(a, this.options.prefix, {
            width: this.width,
            height: this.height
        }), this.clear();
        for (e in this.jobs) conrad.hasJob(e) && conrad.killJob(e);
        for (this.edgesOnScreen = [], this.nodesOnScreen = this.camera.quadtree.area(this.camera.getRectangle(this.width, this.height)), c = this.nodesOnScreen, d = 0, f = c.length; f > d; d++) o[c[d].id] = c[d];
        if (q) {
            for (c = p.edges(), d = 0, f = c.length; f > d; d++) g = c[d], (o[g.source] || o[g.target]) && this.edgesOnScreen.push(g);
            if (this.settings(b, "batchEdgesDrawing")) h = "edges_" + this.conradId, n = t("canvasEdgesBatchSize"), l = this.edgesOnScreen, f = l.length, k = 0, i = Math.min(l.length, k + n), j = function () {
                for (m = sigma.canvas.edges, d = k; i > d; d++) g = l[d], (m[g.type] || m.def)(g, p.nodes(g.source), p.nodes(g.target), this.contexts.edges, t);
                return i === l.length ? (delete this.jobs[h], !1) : (k = i + 1, i = Math.min(l.length, k + n), !0)
            }, this.jobs[h] = j, conrad.addJob(h, j.bind(this));
            else
                for (m = sigma.canvas.edges, c = this.edgesOnScreen, d = 0, f = c.length; f > d; d++) g = c[d], (m[g.type] || m.def)(g, p.nodes(g.source), p.nodes(g.target), this.contexts.edges, t)
        }
        if (r)
            for (m = sigma.canvas.nodes, c = this.nodesOnScreen, d = 0, f = c.length; f > d; d++)(m[c[d].type] || m.def)(c[d], this.contexts.nodes, t);
        if (s)
            for (m = sigma.canvas.labels, c = this.nodesOnScreen, d = 0, f = c.length; f > d; d++)(m[c[d].type] || m.def)(c[d], this.contexts.labels, t);
...
function (a) {
    ...
    sigma.utils.pkg("sigma.renderers"), sigma.renderers.webgl = function (a, b, c, d) {
        ...
        for (sigma.classes.dispatcher.extend(this), this.jobs = {}, Object.defineProperty(this, "conradId", {
            ...
            value: {}
        }), this.initDOM("canvas", "scene", !0), this.initDOM("canvas", "labels"), this.initDOM("canvas", "mouse"), this.contexts.hover = this.contexts.mouse, this.contexts.nodes = this.contexts.scene, this.contexts.edges = this.contexts.scene, this.captors = [], g = this.options.captors || [sigma.captors.mouse, sigma.captors.touch], e = 0, f = g.length; f > e; e++) h = "function" == typeof g[e] ? g[e] : sigma.captors[g[e]], this.captors.push(new h(this.domElements.mouse, this.camera, this.settings));
        window.addEventListener("resize", function () {
            i.resize()
        ...
        for (d in this.nodeFloatArrays)
            for (e = sigma.webgl.nodes[d], a = this.nodeFloatArrays[d].nodes, b = 0, c = a.length; c > b; b++) this.nodeFloatArrays[d].array || (this.nodeFloatArrays[d].array = new Float32Array(a.length * e.POINTS * e.ATTRIBUTES)), e.addNode(a[b], this.nodeFloatArrays[d].array, b * e.POINTS * e.ATTRIBUTES, g.prefix, this.settings);
        return this
        ...
        if (n)
            ...
            }, d = 0, e = c.length; e > d; d++)(sigma.canvas.labels[c[d].type] || sigma.canvas.labels.def)(c[d], this.contexts.labels, g);
        return this.dispatchEvent("render"), this
...
function () {
    ...
    b && (a = document.createElement("canvas"), b = !(!a.getContext("webgl") && !a.getContext("experimental-webgl"))), sigma.renderers.def = b ? sigma.renderers.webgl : sigma.renderers.canvas
}.call(this),
function () {
    "use strict";
...
function () {
    ...
    sigma.utils.pkg("sigma.canvas.hovers"), sigma.canvas.hovers.def = function (a, b, c) {
        ...
        b.font = (i ? i + " " : "") + l + "px " + (c("hoverFont") || c("font")), b.beginPath(), b.fillStyle = "node" === c("labelHoverBGColor") ? a.color || c("defaultNodeColor") : c("defaultHoverLabelBGColor"), c("labelHoverShadow") && (b.shadowOffsetX = 0, b.shadowOffsetY = 0, b.shadowBlur = 8, b.shadowColor = c("labelHoverShadowColor")), "string" == typeof a.label && (d = Math.round(a[j + "x"] - l / 2 - 2), e = Math.round(a[j + "y"] - l / 2 - 2), f = Math.round(b.measureText(a.label).width + l / 2 + k + 7), g = Math.round(l + 4), h = Math.round(l / 2 + 2), b.moveTo(d, e + h), b.arcTo(d, e, d + h, e, h), b.lineTo(d + f, e), b.lineTo(d + f, e + g), b.lineTo(d + h, e + g), b.arcTo(d, e + g, d, e + g - h, h), b.lineTo(d, e + h), b.closePath(), b.fill(), b.shadowOffsetX = 0, b.shadowOffsetY = 0, b.shadowBlur = 0), c("borderSize") > 0 && (b.beginPath(), b.fillStyle = "node" === c("nodeBorderColor") ? a.color || c("defaultNodeColor") : c("defaultNodeBorderColor"), b.arc(a[j + "x"], a[j + "y"], k + c("borderSize"), 0, 2 * Math.PI, !0), b.closePath(), b.fill());
...
function () {
    ...
    sigma.utils.pkg("sigma.canvas.edges"), sigma.canvas.edges.def = function (a, b, c, d, e) {
        ...
        d.strokeStyle = f, d.lineWidth = a[g + "size"] || 1, d.beginPath(), d.moveTo(b[g + "x"], b[g + "y"]), d.lineTo(c[g + "x"], c[g + "y"]), d.stroke()
    }
}(),
function () {
    "use strict";
...
function () {
    ...
    sigma.utils.pkg("sigma.middlewares"), sigma.utils.pkg("sigma.utils"), sigma.middlewares.rescale = function (a, b, c) {
        var d, e, f, g, h, i, j, k, l = this.graph.nodes(),
            ...
            v = n("width") || 1,
            w = n("height") || 1;
        for (j = "outside" === n("scalingMode") ? Math.max(v / Math.max(r - p, 1), w / Math.max(s - q, 1)) : Math.min(v / Math.max(r - p, 1), w / Math.max(s - q, 1)), k = (n("rescaleIgnoreSize") ? 0 : (n("maxNodeSize") || t) / j) + (n("sideMargin") || 0), r += k, p -= k, s += k, q -= k, j = "outside" === n("scalingMode") ? Math.max(v / Math.max(r - p, 1), w / Math.max(s - q, 1)) : Math.min(v / Math.max(r - p, 1), w / Math.max(s - q, 1)), n("maxNodeSize") || n("minNodeSize") ? n("maxNodeSize") === n("minNodeSize") ? (f = 0, g = n("maxNodeSize")) : (f = (n("maxNodeSize") - n("minNodeSize")) / t, g = n("minNodeSize")) : (f = 1, g = 0), n("maxEdgeSize") || n("minEdgeSize") ? n("maxEdgeSize") === n("minEdgeSize") ? (h = 0, i = n("minEdgeSize")) : (h = (n("maxEdgeSize") - n("minEdgeSize")) / u, i = n("minEdgeSize")) : (h = 1, i = 0), d = 0, e = m.length; e > d; d++) m[d][b + "size"] = m[d][a + "size"] * h + i;
        for (d = 0, e = l.length; e > d; d++) l[d][b + "size"] = l[d][a + "size"] * f + g, l[d][b + "x"] = (l[d][a + "x"] - (r + p) / 2) * j, l[d][b + "y"] = (l[d][a + "y"] - (s + q) / 2) * j
...
function () {
    ...
    sigma.utils.pkg("sigma.misc"), sigma.misc.bindEvents = function (a) {
        function b(b) {
            ...
            if (r.length)
                for (c = 0, e = r.length; e > c; c++)
                    if (i = r[c], j = i[a + "x"], k = i[a + "y"], l = i[a + "size"], o > j - l && j + l > o && p > k - l && k + l > p && Math.sqrt(Math.pow(o - j, 2) + Math.pow(p - k, 2)) < l) {
        ...
        function c(a) {
            function c(a) {
                h.settings("eventsEnabled") && (h.dispatchEvent("click", a.data), f = b(a), f.length ? (h.dispatchEvent("clickNode", {
                    node: f[0]
            ...
            function d() {
                if (h.settings("eventsEnabled")) {
                    var a, b, c, d = [];
                    for (a in g) d.push(g[a]);
                    for (g = {}, b = 0, c = d.length; c > b; b++) h.dispatchEvent("outNode", {
                        node: d[b]
                    });
            ...
            function e(a) {
                if (h.settings("eventsEnabled")) {
                    ...
                    var c, d, e, i = [],
                        j = [],
                        k = {}, l = f.length;
                    for (c = 0; l > c; c++) e = f[c], k[e.id] = e, g[e.id] || (j.push(e), g[e.id] = e);
                    for (d in g) k[d] || (i.push(g[d]), delete g[d]);
                    for (c = 0, l = j.length; l > c; c++) h.dispatchEvent("overNode", {
                        node: j[c]
                    });
                    for (c = 0, l = i.length; l > c; c++) h.dispatchEvent("outNode", {
                        node: i[c]
                    });
                    j.length && h.dispatchEvent("overNodes", {
                        nodes: j
                    }), i.length && h.dispatchEvent("outNodes", {
                        nodes: i
                    })
                }
            }
            var f, g = {};
            a.bind("click", c), a.bind("mouseup", e), a.bind("mousemove", e), a.bind("mouseout", d)
        }
        var d, e, f, g, h = this;
...
function () {
    ...
    sigma.utils.pkg("sigma.misc"), sigma.misc.drawHovers = function (a) {
        function b() {
            ...
            var b, e = sigma.canvas.hovers,
                f = c.settings.embedObjects({
                    prefix: a
                });
            if (f("enableHovering"))
                for (b in d)(e[d[b].type] || e.def)(d[b], c.contexts.hover, f)
        }
        var c = this,
            d = {};
        this.bind("overNodes", function (a) {
            var c, e = a.data.nodes,
                f = e.length;
            for (c = 0; f > c; c++) d[e[c].id] = e[c];
            b()
        }), this.bind("outNodes", function (a) {
            var c, e = a.data.nodes,
                f = e.length;
            for (c = 0; f > c; c++) delete d[e[c].id];
            b()
