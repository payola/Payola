...
class GraphPresenter(val viewElement: html.Element, prefixApplier: PrefixApplier, startEvaluationId: Option[String] = None) extends Presenter
{
    val view = new PluginSwitchView(prefixApplier, startEvaluationId)
