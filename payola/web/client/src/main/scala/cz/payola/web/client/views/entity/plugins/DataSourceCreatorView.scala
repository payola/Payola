...
{
    /*val nameInput = new TextInputControl("Name", "", "", "")

    val descriptionInput = new TextInputControl("Description", "", "", "")

    val publicityInput = new CheckboxInputControl("Public", "", "", "")

    val pluginInput = new SelectInputControl("Plugin")
