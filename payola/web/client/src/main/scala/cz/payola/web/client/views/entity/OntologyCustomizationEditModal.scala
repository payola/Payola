...
import cz.payola.web.client.presenters.ShareButtonPresenter
        ...
        "ontology-customization-modal")
{
    ...
    val shareButtonSpan = new Span(Nil)
    val shareButtonPresenter = new ShareButtonPresenter(shareButtonSpan.domElement, "customization", customization.id, customization.isPublic)
    ...
    val buttonsDiv = new Div(List(shareButtonSpan, deleteButtonSpan), "btn-group span6")
