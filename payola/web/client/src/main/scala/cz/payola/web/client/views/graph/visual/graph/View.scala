...
trait View[A]
{
     ...
     */
    protected def drawBezierCurve(context: CanvasRenderingContext2D, origin: Point2D, destination: Point2D,
        color: Color, lineWidth: Double, straightenIndex: Double) {
    ...
    /**
      ...
      * @param color of the line
      */
    private def performBezierCurveDrawing(context: CanvasRenderingContext2D, control1: Point2D, control2: Point2D,
     ...
     */
    protected def prepareImage(imagePath: String): Canvas = {
     ...
     */
    protected def setColorOfDrawnElements(canvas: Canvas, startPoint: Point2D, endPoint: Point2D, color: Color): Canvas = {
        val context = canvas.getContext[CanvasRenderingContext2D]("2d")
