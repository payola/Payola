...
import s2js.adapters.js.dom.{Element, Document, Node}
...
abstract class AbstractRange
{
    ...
    def getTextRange(i: Int): s2js.adapters.goog.dom.TextRange
}

class TextRange extends AbstractRange
{
    def getTextRange(i: Int): s2js.adapters.goog.dom.TextRange = null

    def isCollapsed(): Boolean = false

    def getBrowserRangeObject(): s2js.adapters.js.dom.Range = null
}
