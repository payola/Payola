...
/** A tuple of 3 elements; the canonical representation of a [[scala.Product3]].
  *
  * @constructor  Create a new tuple with 3 elements. Note that it is more idiomatic to create a Tuple3 via `(t1, t2,
  * t3)`
    ...
    extends Product3[T1, T2, T3]
{
    ...
    def zipped[Repr1, El1, Repr2, El2, Repr3, El3](implicit w1: T1 => TLike[El1, Repr1],
                                                            ...
                                                            w3: T3 => ILike[El3, Repr3]): Zipped[Repr1, El1, Repr2,
                                                            El2, Repr3, El3]
