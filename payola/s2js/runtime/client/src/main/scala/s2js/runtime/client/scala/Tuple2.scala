    ...
    extends Product2[T1, T2]
{
     ...
     * Note that there must be an implicit value to convert this tuple's types into a [[scala.collection
     * .TraversableLike]]
     ...
     */
    def zipped[Repr1, El1, Repr2, El2](implicit w1: T1 => TLike[El1, Repr1], w2: T2 => ILike[El2,
    Repr2]): Zipped[Repr1, El1, Repr2, El2]
      = new Zipped[Repr1, El1, Repr2, El2](_1, _2)

    class Zipped[+Repr1, +El1, +Repr2, +El2](coll1: TLike[El1, Repr1], coll2: ILike[El2,
    Repr2]) { // coll2: ILike for filter
      ...
      def filter[To1, To2](f: (El1, El2) => Boolean)(implicit cbf1: CBF[Repr1, El1, To1], cbf2: CBF[Repr2, El2,
      To2]): (To1, To2) = {
