...
/** A tuple of 10 elements; the canonical representation of a [[scala.Product10]].
  *
  * @constructor  Create a new tuple with 10 elements. Note that it is more idiomatic to create a Tuple10 via `(t1,
  ...
  */
case class Tuple10[+T1, +T2, +T3, +T4, +T5, +T6, +T7, +T8, +T9, +T10](_1: T1, _2: T2, _3: T3, _4: T4, _5: T5, _6: T6,
    _7: T7, _8: T8, _9: T9, _10: T10)
