...
trait Iterable
{
    ...
    def reduceLeft(op: (Double, Double) => Double): Double = {
        if (isEmpty) {
            throw new s2js.runtime.scala.UnsupportedOperationException("empty.reduceLeft")
        }
    ...
    def reduceRight(op: (Double, Double) => Double): Double = {
        if (isEmpty) {
            throw new s2js.runtime.scala.UnsupportedOperationException("empty.reduceRight")
        }
    ...
    def min: Double = {
        if (isEmpty) {
            throw new s2js.runtime.scala.UnsupportedOperationException("empty.min")
        }
    ...
    def max: Double = {
        if (isEmpty) {
            throw new s2js.runtime.scala.UnsupportedOperationException("empty.max")
        }
    ...
    def maxBy(f: Double => Double): Double = {
        if (isEmpty) {
            throw new s2js.runtime.scala.UnsupportedOperationException("empty.maxBy")
        }
    ...
    def minBy(f: Double => Double): Double = {
        if (isEmpty) {
            throw new s2js.runtime.scala.UnsupportedOperationException("empty.minBy")
        }
    ...
    // From TraversableLike
    def head: Double = {
        var result: () => Double = () => throw new s2js.runtime.scala.NoSuchElementException("empty.head")
        breakable {() =>
            for (x <- this) {
                result = () => x
                break
    ...
    def tail: Iterable = {
        if (isEmpty) {
            throw new s2js.runtime.scala.UnsupportedOperationException("empty.tail")
        }
        drop(1)
    }
    ...
    def init: Iterable = {
        if (isEmpty) {
            throw new s2js.runtime.scala.UnsupportedOperationException("empty.init")
        }
        var lst = head
        var follow = false
        val b = newInstance
