...
class StatementSpecs extends CompilerFixtureSpec {
    ...
    it("support not operator") { configMap =>
    ...
    it("ignore asinstanceof calls") { configMap =>
        expect {"""
            object a {
                def m1(x:String) = {
    ...
    describe("statements") {
        ...
        it("should have a semicolons") { configMap =>
        ...
        it("can access class and module variables") { configMap =>
    ...
    describe("assignments") {
        ...
        it("calling a method of a returned object") { configMap =>
    ...
    describe("function calls") {
        ...
        it("can handle function reference passing") { configMap =>
        ...
        it("can handle default arguments") { configMap =>
        ...
        it("should handle package objects") { configMap =>
        ...
        it("can call parameterized functions") { configMap =>
        ...
        it("should use fully qualified function names") { configMap =>
    ...
    describe("when call a function from same package") {
        ...
        it("should be fully qualified") { configMap =>
