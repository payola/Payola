...
class ArraySpecs extends CompilerFixtureSpec {
    ...
    describe("arrays") {
        ...
        ignore("can be iterated using while statement") { configMap =>
        ...
        ignore("can have numbers") { configMap =>
        ...
        it("can have function call elements") { configMap =>
