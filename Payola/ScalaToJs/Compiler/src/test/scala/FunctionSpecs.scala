...
class FunctionSpecs extends CompilerFixtureSpec {
    ...
    describe("functions") {
      ...
      it("can be higher-orderd") { configMap =>
      ...
      it("can have a return value") { configMap =>
      ...
      it("can have arguments") { configMap =>
  ...
  describe("class functions") {
    ...
    it("override base class functions") { configMap =>
  ...
  describe("anon functions") {
    ...
    it("can be assigned to variables") { configMap =>
    ...
    it("can have multiple statements") { configMap =>
