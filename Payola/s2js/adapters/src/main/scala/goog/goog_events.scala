...
package object events
{
    ...
    def listen[T <: Event](obj: AnyRef, event: String, fn: (T) => Any, some: Boolean, ctx: Any) {}
...
class BrowserEvent(opt_e: Event = null, opt_currentTarget: s2js.adapters.js.dom.Node = null) extends Event("")
{
    val keyCode: Int = 0
}
