package s2js.adapters.goog.editor

import s2js.adapters.js.dom.{Anchor, Element, Document}
import s2js.adapters.goog.dom.{DomHelper, AbstractRange}
...
class Field(id: String, opt_doc: Document = null)
{
    ...
    def getRange(): AbstractRange = null
...
class Plugin
{
    ...
    def getFieldDomHelper(): DomHelper = null
}
